          ...
          {ITEMS.map((it, i) => {
            ...
            return (
              <div
                ...
                className="bg-white rounded-2xl p-6 border border-black/[0.04] hover:border-[#064E3B]/30 transition-all hover:-translate-y-1 duration-300"
              >
                <div className="w-11 h-11 rounded-xl bg-[#064E3B] text-white flex items-center justify-center mb-5">
                ...
                <ul className="space-y-2">
                  {it.bullets.map((b, j) => (
                    <li key={j} className="text-[13px] text-[#475569] leading-relaxed flex gap-2">
                      <span className="text-[#064E3B] mt-1.5 w-1 h-1 rounded-full bg-[#064E3B] shrink-0" />
                      {b}
                    </li>
                  ))}
                </ul>
