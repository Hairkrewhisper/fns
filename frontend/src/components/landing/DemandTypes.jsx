          ...
          {TYPES.map((t, i) => {
            ...
            return (
              <div
                ...
                className="group bg-[#F4F4F1] hover:bg-[#022C22] border border-black/[0.04] rounded-2xl p-6 transition-all duration-300 cursor-pointer"
              >
                <div className="flex items-center justify-between mb-6">
                  <div className="w-10 h-10 rounded-lg bg-white text-[#064E3B] group-hover:bg-emerald-500/15 group-hover:text-emerald-300 flex items-center justify-center transition-colors">
                    <Icon className="w-5 h-5" />
                  </div>
                  <span className="text-[10px] uppercase tracking-[0.16em] font-bold text-[#475569] group-hover:text-emerald-300 transition-colors">
                    {t.tag}
                  </span>
                </div>
                ...
                <p className="text-[13px] leading-relaxed text-[#475569] group-hover:text-white/70 transition-colors">
                  {t.desc}
                </p>
              </div>
            );
